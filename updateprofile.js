...
document.querySelector('form').addEventListener('submit', function(event) {
    ...
    const formData = {
        ...
        zip: this.zip.value,
        skills: Array.from(selectedSkills), // Convert Set to Array
        preferences: this.preferences.value,
        availability: Array.from(selectedDates) // Convert Set to Array
    };
    ...
    // Simulate receiving data from the backend (hardcoded for now)
    //const backendResponse = {
      //  success: true,
       // message: 'Profile updated successfully!',
       // data: formData // Echo back the data for demonstration
    //};

    const backendResponse = processUserData(formData); // Using the backend function directly
    console.log("Backend Response: ", backendResponse);

    if (backendResponse.success) {
        alert(backendResponse.message);
        // Optionally, update the form with the received data
...
import { processUserData } from './backend.js';